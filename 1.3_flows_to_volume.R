...
# READ STREAMFLOW INCLUDING NAN

Data_Qf_m3s               <-readRDS("data_input/Data_Q0_m3s_wys1978-2021.RData")
filename_Q_mensual_melado <-"data_input/Q_Melado_1960-2019_m3s-mes.RData"
...
a=lapply(c("Achibueno","Ancoa","Lontue","Maule","Melado","Longavi"),
         function(cuenca){
           filename_export=paste0("data_auxiliar/Caudal_medio_mensual_2001_2020_",cuenca,"_no_rellenado.csv")
  ...
  feather::write_feather(paste0("data_output/caudal_medio_mensual_1988_presente_q0.feather"))
