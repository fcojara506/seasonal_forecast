...
scores = readRDS(file = "data_output/scores/RDS/scores_20230329_maule.RDS") %>% 
  lapply(join_x_info) %>% 
  rbindlist()%>% 
  sort_months()

scores_ref = readRDS(file = "data_output/scores/RDS/scores_reference_20230329_maule.RDS") %>% 
  lapply(join_x_info) %>% 
  rbindlist() %>% 
  sort_months()
...
ggsave(filename = "data_output/figuras/scores/RMSE_normalizado_best_ref_maule.png",
...
ggsave(filename = "data_output/figuras/scores/R2_best_ref_maule.png",
...
ggsave(filename = "data_output/figuras/scores/MAE_normalizado_best_ref_maule.png",
...
ggsave(filename = "data_output/figuras/scores/pbias_best_ref_maule.png",
...
ggsave(filename = "data_output/figuras/scores/crpss_ref_maule.png",
...
ggsave(filename = "data_output/figuras/scores/crpss_climatologico_ref_best_maule.png",
...
p7 = ggplot(data = subset(df_crpss_avg, version == "Mejor combinación"))+
  ...
  theme(legend.position = "bottom")
ggsave(filename = "data_output/figuras/scores/crpss_best_latitude_maule.png",
...
ggsave(filename = "data_output/figuras/scores/crpss_best_elevation_maule.png",
