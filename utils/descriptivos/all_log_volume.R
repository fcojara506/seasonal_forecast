...
get_results <- function(catchment_code, month_initialisation) {
  ...
  data_input <- preprocess_data(
    ...
    predictor_list = c("pr_sum_-1months"),#predictor not important for this analysis
...
ggsave(filename = "data_output/figuras/informe_final/histogramas_log_volumen/normalidad_Shapiro-Wilk_cuencas_sep_dic.png",
